...
RecyclerView.Adapter<IceCreamAdapter.IceCreamViewHolder>(){
    ...
    class IceCreamViewHolder(private val binding: ThirdIceCreamBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IceCreamViewHolder {
        val binding = ThirdIceCreamBinding.inflate(LayoutInflater.from(parent.context), parent, false)
